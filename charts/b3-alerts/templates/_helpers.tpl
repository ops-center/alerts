...
*/}}
{{- define "b3-alerts.fullname" -}}
{{- printf "%s-%s" .Release.Name "platform-api" | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "b3-alerts.chart" -}}
...
Common labels
*/}}
{{- define "b3-alerts.labels" -}}
helm.sh/chart: {{ include "b3-alerts.chart" . }}
{{ include "b3-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "b3-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "b3-alerts.name" . }}
...
Alerts Enabled
*/}}
{{- define "b3-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "b3-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
