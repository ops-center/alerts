...
*/}}
{{- define "cassandra-alerts.fullname" -}}
...
Common labels
*/}}
{{- define "cassandra-alerts.labels" -}}
helm.sh/chart: {{ include "cassandra-alerts.chart" . }}
{{ include "cassandra-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "cassandra-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "cassandra-alerts.name" . }}
...
Alert labels
*/}}
{{- define "cassandra-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "cassandra-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "cassandra-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "cassandra-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
