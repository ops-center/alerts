...
$ helm repo update
$ helm search repo appscode/connectcluster-alerts --version=v2026.2.24
$ helm upgrade -i connectcluster appscode/connectcluster-alerts -n demo --create-namespace --version=v2026.2.24
```
...
```bash
$ helm upgrade -i connectcluster appscode/connectcluster-alerts -n demo --create-namespace --version=v2026.2.24 --set metadata.resource.group=kafka.kubedb.com
```
...
```bash
$ helm upgrade -i connectcluster appscode/connectcluster-alerts -n demo --create-namespace --version=v2026.2.24 --values values.yaml
```
