...
*/}}
{{- define "connectcluster-alerts.name" -}}
...
*/}}
{{- define "connectcluster-alerts.fullname" -}}
...
*/}}
{{- define "connectcluster-alerts.chart" -}}
...
Common labels
*/}}
{{- define "connectcluster-alerts.labels" -}}
helm.sh/chart: {{ include "connectcluster-alerts.chart" . }}
{{ include "connectcluster-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "connectcluster-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "connectcluster-alerts.name" . }}
...
Alert labels
*/}}
{{- define "connectcluster-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "connectcluster-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "connectcluster-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "connectcluster-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
