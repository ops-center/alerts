...
$ helm repo update
$ helm search repo appscode/druid-alerts --version=v2026.2.24
$ helm upgrade -i druid-sample appscode/druid-alerts -n druid --create-namespace --version=v2026.2.24
```
...
```bash
$ helm upgrade -i druid-sample appscode/druid-alerts -n druid --create-namespace --version=v2026.2.24 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i druid-sample appscode/druid-alerts -n druid --create-namespace --version=v2026.2.24 --values values.yaml
```
