...
Common labels
*/}}
{{- define "druid-alerts.labels" -}}
helm.sh/chart: {{ include "druid-alerts.chart" . }}
{{ include "druid-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "druid-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "druid-alerts.name" . }}
...
Alerts Enabled
*/}}
{{- define "druid-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "druid-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "druid-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
