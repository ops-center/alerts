...
$ helm repo update
$ helm search repo appscode/elasticsearch-alerts --version=v2023.04.10
$ helm upgrade -i elasticsearch appscode/elasticsearch-alerts -n demo --create-namespace --version=v2023.04.10
```
...
```bash
$ helm upgrade -i elasticsearch appscode/elasticsearch-alerts -n demo --create-namespace --version=v2023.04.10 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i elasticsearch appscode/elasticsearch-alerts -n demo --create-namespace --version=v2023.04.10 --values values.yaml
```
