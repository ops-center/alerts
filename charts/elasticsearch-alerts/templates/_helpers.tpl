...
*/}}
{{- define "elasticsearch-alerts.name" -}}
...
*/}}
{{- define "elasticsearch-alerts.fullname" -}}
...
*/}}
{{- define "elasticsearch-alerts.chart" -}}
...
Common labels
*/}}
{{- define "elasticsearch-alerts.labels" -}}
helm.sh/chart: {{ include "elasticsearch-alerts.chart" . }}
{{ include "elasticsearch-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "elasticsearch-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "elasticsearch-alerts.name" . }}
...
Alert labels
*/}}
{{- define "elasticsearch-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "elasticsearch-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "elasticsearch-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "elasticsearch-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
