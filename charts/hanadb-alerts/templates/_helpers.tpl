...
Common labels
*/}}
{{- define "hanadb-alerts.labels" -}}
helm.sh/chart: {{ include "hanadb-alerts.chart" . }}
{{ include "hanadb-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "hanadb-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "hanadb-alerts.name" . }}
...
Alerts Enabled
*/}}
{{- define "hanadb-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "hanadb-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "hanadb-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
