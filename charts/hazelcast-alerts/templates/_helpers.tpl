...
*/}}
{{- define "hazelcast-alerts.fullname" -}}
...
Common labels
*/}}
{{- define "hazelcast-alerts.labels" -}}
helm.sh/chart: {{ include "hazelcast-alerts.chart" . }}
{{ include "hazelcast-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "hazelcast-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "hazelcast-alerts.name" . }}
...
Alert labels
*/}}
{{- define "hazelcast-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "hazelcast-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "hazelcast-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "hazelcast-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
