...
*/}}
{{- define "mariadb-alerts.fullname" -}}
...
Common labels
*/}}
{{- define "mariadb-alerts.labels" -}}
helm.sh/chart: {{ include "mariadb-alerts.chart" . }}
{{ include "mariadb-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "mariadb-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "mariadb-alerts.name" . }}
...
Alert labels
*/}}
{{- define "mariadb-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "mariadb-alerts.alertsEnabled" -}}
