...
*/}}
{{- define "memcached-alerts.fullname" -}}
...
Common labels
*/}}
{{- define "memcached-alerts.labels" -}}
helm.sh/chart: {{ include "memcached-alerts.chart" . }}
{{ include "memcached-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "memcached-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "memcached-alerts.name" . }}
...
Alert labels
*/}}
{{- define "memcached-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "memcached-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "memcached-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "memcached-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
