...
Common labels
*/}}
{{- define "milvus-alerts.labels" -}}
helm.sh/chart: {{ include "milvus-alerts.chart" . }}
{{ include "milvus-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "milvus-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "milvus-alerts.name" . }}
...
Alerts Enabled
*/}}
{{- define "milvus-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "milvus-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "milvus-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
