...
$ helm repo update
$ helm search repo appscode/mongodb-alerts --version=v2025.6.30
$ helm upgrade -i mongodb appscode/mongodb-alerts -n demo --create-namespace --version=v2025.6.30
```
...
```bash
$ helm upgrade -i mongodb appscode/mongodb-alerts -n demo --create-namespace --version=v2025.6.30 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i mongodb appscode/mongodb-alerts -n demo --create-namespace --version=v2025.6.30 --values values.yaml
```
