...
$ helm repo update
$ helm search repo appscode/mongodb-alerts --version=v2023.04.10
$ helm upgrade -i mongodb appscode/mongodb-alerts -n demo --create-namespace --version=v2023.04.10
```
...
```bash
$ helm upgrade -i mongodb appscode/mongodb-alerts -n demo --create-namespace --version=v2023.04.10 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i mongodb appscode/mongodb-alerts -n demo --create-namespace --version=v2023.04.10 --values values.yaml
```
