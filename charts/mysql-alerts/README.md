...
$ helm repo update
$ helm search repo appscode/mysql-alerts --version=v2023.05.09
$ helm upgrade -i mysql appscode/mysql-alerts -n demo --create-namespace --version=v2023.05.09
```
...
```bash
$ helm upgrade -i mysql appscode/mysql-alerts -n demo --create-namespace --version=v2023.05.09 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i mysql appscode/mysql-alerts -n demo --create-namespace --version=v2023.05.09 --values values.yaml
```
