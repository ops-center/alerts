...
$ helm repo update
$ helm search repo appscode/mysql-alerts --version=v2025.3.24
$ helm upgrade -i mysql appscode/mysql-alerts -n demo --create-namespace --version=v2025.3.24
```
...
```bash
$ helm upgrade -i mysql appscode/mysql-alerts -n demo --create-namespace --version=v2025.3.24 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i mysql appscode/mysql-alerts -n demo --create-namespace --version=v2025.3.24 --values values.yaml
```
