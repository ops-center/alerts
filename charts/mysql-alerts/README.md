...
$ helm repo update
$ helm search repo appscode/mysql --version=v2023.04.10
$ helm upgrade -i mysql appscode/mysql -n demo --create-namespace --version=v2023.04.10
```
...
```bash
$ helm upgrade -i mysql appscode/mysql -n demo --create-namespace --version=v2023.04.10 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i mysql appscode/mysql -n demo --create-namespace --version=v2023.04.10 --values values.yaml
```
