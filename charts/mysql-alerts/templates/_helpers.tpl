...
Common labels
*/}}
{{- define "mysql-alerts.labels" -}}
helm.sh/chart: {{ include "mysql-alerts.chart" . }}
{{ include "mysql-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "mysql-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "mysql-alerts.name" . }}
...
Alerts Enabled
*/}}
{{- define "mysql-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "mysql-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "mysql-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
