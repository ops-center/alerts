...
Common labels
*/}}
{{- define "nats-alerts.labels" -}}
helm.sh/chart: {{ include "nats-alerts.chart" . }}
{{ include "nats-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "nats-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "nats-alerts.name" . }}
...
Alert labels
*/}}
{{- define "nats-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "nats-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "nats-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "nats-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
