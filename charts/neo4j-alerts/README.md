...
$ helm repo update
$ helm search repo appscode/neo4j-alerts --version=v2026.2.24
$ helm upgrade -i neo4j-alerts appscode/neo4j-alerts -n kubedb --create-namespace --version=v2026.2.24
```
...
```bash
$ helm upgrade -i neo4j-alerts appscode/neo4j-alerts -n kubedb --create-namespace --version=v2026.2.24 --set metadata:
  resource:
    group: kubedb.com
    kind: Neo4j
    name: neo4js
...
```bash
$ helm upgrade -i neo4j-alerts appscode/neo4j-alerts -n kubedb --create-namespace --version=v2026.2.24 --values values.yaml
```
