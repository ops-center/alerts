...
Common labels
*/}}
{{- define "neo4j-alerts.labels" -}}
helm.sh/chart: {{ include "neo4j-alerts.chart" . }}
{{ include "neo4j-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "neo4j-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "neo4j-alerts.name" . }}
...
Alert labels
*/}}
{{- define "neo4j-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "neo4j-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "neo4j-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "neo4j-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
