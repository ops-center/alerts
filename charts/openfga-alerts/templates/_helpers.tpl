...
*/}}
{{- define "openfga-alerts.fullname" -}}
{{- printf "%s-%s" .Release.Name "openfga" | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "openfga-alerts.chart" -}}
...
Common labels
*/}}
{{- define "openfga-alerts.labels" -}}
helm.sh/chart: {{ include "openfga-alerts.chart" . }}
{{ include "openfga-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "openfga-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "openfga-alerts.name" . }}
...
Alert labels
*/}}
{{- define "openfga-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "openfga-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "openfga-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "openfga-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
