...
Common labels
*/}}
{{- define "oracle-alerts.labels" -}}
helm.sh/chart: {{ include "oracle-alerts.chart" . }}
{{ include "oracle-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "oracle-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "oracle-alerts.name" . }}
...
Alerts Enabled
*/}}
{{- define "oracle-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "oracle-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "oracle-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
