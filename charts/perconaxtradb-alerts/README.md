...
$ helm repo update
$ helm search repo appscode/perconaxtradb-alerts --version=v2025.6.30
$ helm upgrade -i perconaxtradb appscode/perconaxtradb-alerts -n demo --create-namespace --version=v2025.6.30
```
...
```bash
$ helm upgrade -i perconaxtradb appscode/perconaxtradb-alerts -n demo --create-namespace --version=v2025.6.30 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i perconaxtradb appscode/perconaxtradb-alerts -n demo --create-namespace --version=v2025.6.30 --values values.yaml
```
