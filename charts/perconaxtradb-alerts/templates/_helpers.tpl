...
*/}}
{{- define "perconaxtradb-alerts.name" -}}
...
*/}}
{{- define "perconaxtradb-alerts.fullname" -}}
...
*/}}
{{- define "perconaxtradb-alerts.chart" -}}
...
Common labels
*/}}
{{- define "perconaxtradb-alerts.labels" -}}
helm.sh/chart: {{ include "perconaxtradb-alerts.chart" . }}
{{ include "perconaxtradb-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "perconaxtradb-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "perconaxtradb-alerts.name" . }}
...
Alert labels
*/}}
{{- define "perconaxtradb-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "perconaxtradb-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "perconaxtradb-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "perconaxtradb-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
