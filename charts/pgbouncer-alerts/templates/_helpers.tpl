...
*/}}
{{- define "pgbouncer-alerts.fullname" -}}
...
Common labels
*/}}
{{- define "pgbouncer-alerts.labels" -}}
helm.sh/chart: {{ include "pgbouncer-alerts.chart" . }}
{{ include "pgbouncer-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "pgbouncer-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "pgbouncer-alerts.name" . }}
...
Alert labels
*/}}
{{- define "pgbouncer-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "pgbouncer-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "pgbouncer-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "pgbouncer-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
