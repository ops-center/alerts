...
Common labels
*/}}
{{- define "pgpool-alerts.labels" -}}
helm.sh/chart: {{ include "pgpool-alerts.chart" . }}
{{ include "pgpool-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "pgpool-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "pgpool-alerts.name" . }}
...
Alerts Enabled
*/}}
{{- define "pgpool-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "pgpool-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "pgpool-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
