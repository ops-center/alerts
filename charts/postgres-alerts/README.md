...
$ helm repo update
$ helm search repo appscode/postgres-alerts --version=v2023.05.09
$ helm upgrade -i postgres appscode/postgres-alerts -n demo --create-namespace --version=v2023.05.09
```
...
```bash
$ helm upgrade -i postgres appscode/postgres-alerts -n demo --create-namespace --version=v2023.05.09 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i postgres appscode/postgres-alerts -n demo --create-namespace --version=v2023.05.09 --values values.yaml
```
