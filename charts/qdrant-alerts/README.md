...
| grafana.url                                                           |                                               | <code>"http://prometheus-grafana.monitoring.svc.cluster.local"</code> |
| grafana.user                                                          |                                               | <code>"admin"</code>                                                  |
| grafana.password                                                      |                                               | <code>"cNbFOgGgmFkzpFme9heVHd4UuOLlDlIL2fERuXSz"</code>               |
