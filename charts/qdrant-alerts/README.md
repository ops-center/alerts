...
$ helm repo update
$ helm search repo appscode/qdrant-alerts --version=v2026.2.24
$ helm upgrade -i qdrant appscode/qdrant-alerts -n demo --create-namespace --version=v2026.2.24
```
...
```bash
$ helm upgrade -i qdrant appscode/qdrant-alerts -n demo --create-namespace --version=v2026.2.24 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i qdrant appscode/qdrant-alerts -n demo --create-namespace --version=v2026.2.24 --values values.yaml
```
