...
Common labels
*/}}
{{- define "qdrant-alerts.labels" -}}
helm.sh/chart: {{ include "qdrant-alerts.chart" . }}
{{ include "qdrant-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "qdrant-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "qdrant-alerts.name" . }}
...
Alert labels
*/}}
{{- define "qdrant-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "qdrant-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "qdrant-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "qdrant-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
