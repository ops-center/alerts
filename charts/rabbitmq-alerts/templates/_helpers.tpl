...
*/}}
{{- define "rabbitmq-alerts.fullname" -}}
...
Common labels
*/}}
{{- define "rabbitmq-alerts.labels" -}}
helm.sh/chart: {{ include "rabbitmq-alerts.chart" . }}
{{ include "rabbitmq-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "rabbitmq-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "rabbitmq-alerts.name" . }}
...
Alert labels
*/}}
{{- define "rabbitmq-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "rabbitmq-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "rabbitmq-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "rabbitmq-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
