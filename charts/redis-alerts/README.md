...
$ helm repo update
$ helm search repo appscode/redis-alerts --version=v2024.12.18
$ helm upgrade -i redis appscode/redis-alerts -n demo --create-namespace --version=v2024.12.18
```
...
```bash
$ helm upgrade -i redis appscode/redis-alerts -n demo --create-namespace --version=v2024.12.18 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i redis appscode/redis-alerts -n demo --create-namespace --version=v2024.12.18 --values values.yaml
```
