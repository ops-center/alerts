...
$ helm repo update
$ helm search repo appscode/redis-alerts --version=v2025.3.24
$ helm upgrade -i redis appscode/redis-alerts -n demo --create-namespace --version=v2025.3.24
```
...
```bash
$ helm upgrade -i redis appscode/redis-alerts -n demo --create-namespace --version=v2025.3.24 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i redis appscode/redis-alerts -n demo --create-namespace --version=v2025.3.24 --values values.yaml
```
