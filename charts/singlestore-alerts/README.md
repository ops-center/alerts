...
$ helm repo update
$ helm search repo appscode/singlestore-alerts --version=v2026.2.24
$ helm upgrade -i singlestore appscode/singlestore-alerts -n demo --create-namespace --version=v2026.2.24
```
...
```bash
$ helm upgrade -i singlestore appscode/singlestore-alerts -n demo --create-namespace --version=v2026.2.24 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i singlestore appscode/singlestore-alerts -n demo --create-namespace --version=v2026.2.24 --values values.yaml
```
