...
Common labels
*/}}
{{- define "solr-alerts.labels" -}}
helm.sh/chart: {{ include "solr-alerts.chart" . }}
{{ include "solr-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "solr-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "solr-alerts.name" . }}
...
Alert labels
*/}}
{{- define "solr-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "solr-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "solr-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "solr-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
