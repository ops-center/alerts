...
$ helm repo update
$ helm search repo appscode/vaultserver-alerts --version=v2025.3.24
$ helm upgrade -i vaultserver appscode/vaultserver-alerts -n demo --create-namespace --version=v2025.3.24
```
...
```bash
$ helm upgrade -i vaultserver appscode/vaultserver-alerts -n demo --create-namespace --version=v2025.3.24 --set metadata.resource.group=kubevault.com
```
...
```bash
$ helm upgrade -i vaultserver appscode/vaultserver-alerts -n demo --create-namespace --version=v2025.3.24 --values values.yaml
```
