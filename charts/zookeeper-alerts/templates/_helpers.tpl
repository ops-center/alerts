...
*/}}
{{- define "zookeeper-alerts.fullname" -}}
...
Common labels
*/}}
{{- define "zookeeper-alerts.labels" -}}
helm.sh/chart: {{ include "zookeeper-alerts.chart" . }}
{{ include "zookeeper-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "zookeeper-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "zookeeper-alerts.name" . }}
...
Alert labels
*/}}
{{- define "zookeeper-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "zookeeper-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "zookeeper-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "zookeeper-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
